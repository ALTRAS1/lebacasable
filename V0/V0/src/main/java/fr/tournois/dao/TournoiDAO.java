...
public class TournoiDAO {
    ...
    /**
     * Récupère la liste des tournois en cours
    ...
    /**
     * Récupère la liste des tournois à venir
     * @return Liste des tournois dont la date de début est future
     * @throws DAOException si erreur lors de la recherche
     */
    ...
    /**
     * Récupère les affectations de staff pour un tournoi
     * @param tournoi Tournoi dont on veut les affectations
     * @return Liste des affectations du tournoi
